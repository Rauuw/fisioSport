...
<div class="container-bottom-3">
    <div class="col-lg-2 col-md-2 col-xs-12 col-sm-6">
        <button class="section2_btn btn2" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">+ Crear Paciente </button>
    </div>
            ...
            <tbody>
                ...
                <tr class="align-middle alert" role="alert">
                    ...
                    <td>
                        <div class="row">
                            <div class="col">
                                <a href="{{ route('listar_rutina', ['id' => $paciente->user->id]) }}" class="section3_btn btn4" style="color: white;">
                                    Añadir Rutina
                                </a>
                            </div>
                            ...
                            <div class="col">
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    <button type="button" class="section4_btn btn33"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                            <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z" />
                                        </svg></button>
                                    <button type="button" class="section4_btn btn22"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                            <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0" />
                                            <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7" />
                                        </svg></button>
                                    <button type="button" class="section4_btn btn11"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
